...
<body>
						...
						<form class="listWrap">
							...
							<div class="listContentBox">
								<div class="rentalInfo">
					                ...
					                <input type="hidden" name="rentallistid" value="${returnrequest.rentallistid}">
					                <input type="hidden" name="isbn" value="${returnrequest.isbn}">
					                <input type="hidden" name="title" value="${returnrequest.title}">
					                <input type="hidden" name="bookimgurl" value="${returnrequest.bookimgurl}">
					                <input type="hidden" name="requestdate" value="${returnrequest.requestdate}">
					            </div>
							</div>
							<div class="listBtnBox">
								<%-- <input type="button" value="반납요청 확인" class="checkButton" data-returnrequestid="${returnrequest.returnrequestid}"> --%>
								<c:choose>
							        ...
							        <c:otherwise>
							            ...
							            <input type="button" value="반납처리 완료">
							        </c:otherwise>
							    </c:choose>
							</div>
						</form>
	...
	$(document).ready(function () {
        $('.checkButton').on('click', function () {
            ...
            var rentallistid = $(this).closest(".listWrap").find("input[name='rentallistid']").val();
            ...
            var requestdate = $(this).closest(".listWrap").find("input[name='requestdate']").val();
            
            // AJAX 요청
            $.ajax({
                type: 'POST',
                url: '/return/returnModify',  
                data: { 
